...
{  
  ...
  // Envelope parameters
  //
  G4double env_sizeXY = 262*m, env_sizeZ = 262*m;
...
*/
  ...
  G4ThreeVector pos2 = G4ThreeVector(0*m, -16*m, 0*m);
  // Trap shape       
  G4double shape2_dxa = 120*m, shape2_dxb = 120*m;
  G4double shape2_dya = 120*m, shape2_dyb = 120*m;
  G4double shape2_dz  = 10*m;      
  G4Trd* solidShape2 =    
