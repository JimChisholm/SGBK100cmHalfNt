...
G4Material* Cr2O3 = new G4Material("IronOxide", 5.22*g/cm3, 2);
...
//G4int ncomponents;
  ...
  G4ThreeVector pos2 = G4ThreeVector(0*cm, -12*cm, 0*cm);
  // Trap shape       
  G4double shape2_dxa = 54.6*cm, shape2_dxb = 54.6*cm;
  G4double shape2_dya = 54.5*cm, shape2_dyb = 54.7*cm;
  G4double shape2_dz  = 5.3*cm;      
  G4Trd* solidShape2 =    
